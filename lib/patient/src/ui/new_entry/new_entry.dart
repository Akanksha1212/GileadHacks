...
import 'package:immuno_ai/patient/src/common/convert_time.dart';
import 'package:immuno_ai/patient/src/global_bloc.dart';
import 'package:immuno_ai/patient/src/models/errors.dart';
import 'package:immuno_ai/patient/src/models/medicine.dart';
import 'package:immuno_ai/patient/src/models/medicine_type.dart';
import 'package:immuno_ai/patient/src/ui/homepage/homepage.dart';
import 'package:immuno_ai/patient/src/ui/new_entry/new_entry_bloc.dart';
import 'package:immuno_ai/patient/src/ui/success_screen/success_screen.dart';
                    ...
                    return Row(
                      ...
                      children: <Widget>[
                        MedicineTypeColumn(
                            ...
                            name: "Bottle",
                            iconAdd:
                                "https://image.flaticon.com/icons/png/128/3022/3022827.png",
                        ...
                        MedicineTypeColumn(
                            ...
                            name: "Pill",
                            iconAdd:
                                "https://image.flaticon.com/icons/png/128/822/822143.png",
                        ...
                        MedicineTypeColumn(
                            ...
                            name: "Syringe",
                            iconAdd:
                                "https://image.flaticon.com/icons/png/128/477/477369.png",
                        ...
                        MedicineTypeColumn(
                            ...
                            name: "Tablet",
                            iconAdd:
                                "https://image.flaticon.com/icons/png/512/4005/4005958.png",
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xffd84571),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? Color(0xffd84571) : Colors.white,
            ),
            child: Center(
              child: Padding(
                padding: EdgeInsets.only(top: 14.0),
                child: Image.network(iconAdd),
              ),
            ),
          ),
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xffd84571) : Colors.transparent,
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 16,
                    color: isSelected ? Colors.white : Color(0xffd84571),
                    fontWeight: FontWeight.w500,
                  ),
                ),
              ),
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: Color(0xffd84571)),
          ),
        ]),
      ),
    );
